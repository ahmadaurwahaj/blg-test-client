          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="text-center space-y-4 mb-8">
              ...
              <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                Enter your website URL and we will analyze all the technical issues you need to fix in order to improve your chances of being cited by LLMs (ChatGPT and Gemini).
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {/* Step 1 */}
              <Card className="relative p-8 bg-gradient-to-br from-slate-50 to-white border border-slate-200 rounded-3xl hover:shadow-xl transition-all duration-300">
                {/* Large Number */}
